...
final class FeedSnapshotTests: XCTestCase {
    ...
    func test_feedWithFailedImageLoading() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone13(style: .light)), named: "FEED_WITH_FAILED_LOADING_light")
        assert(snapshot: sut.snapshot(for: .iPhone13(style: .dark)), named: "FEED_WITH_FAILED_LOADING_dark")
        assert(snapshot: sut.snapshot(for: .iPhone13(style: .light, contentSize: .extraExtraExtraLarge)), named: "FEED_WITH_FAILED_LOADING_light_extraExtraExtraLarge")
    }
